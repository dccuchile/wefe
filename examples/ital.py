...
target_sets1 = [['maschio', 'uomo', 'ragazzo', 'fratello', 'lui', 'lui', 'il suo', 'figlio'], ['femmina', 'donna', 'ragazza', 'sorella', 'lei', 'sua', 'la sua', 'figlia']]
target_sets_names1 = ['Male Terms', 'Female Terms']
attribute_sets1 = [['esecutivo', 'gestione', 'professionale', 'società', 'stipendio', 'ufficio', 'attività commerciale', 'carriera'], ['casa', 'genitori', 'figli', 'famiglia', 'cugini', 'matrimonio', 'nozze', 'parenti']]
...
# create the word sets
target_sets2 = [['maschio', 'uomo', 'ragazzo', 'fratello', 'lui', 'lui', 'il suo', 'figlio'], ['femmina', 'donna', 'ragazza', 'sorella', 'lei', 'sua', 'la sua', 'figlia']]
target_sets_names2 = ['Male Terms', 'Female Terms']
attribute_sets2 = [['scienza', 'tecnologia', 'fisica', 'chimica', 'Einstein', 'NASA', 'sperimentare', 'astronomia'], ['poesia', 'arte', 'danza', 'letteratura', 'romanzo', 'sinfonia', 'Dramma', 'scultura']]
...
# create the word sets
target_sets3 = [['maschio', 'uomo', 'ragazzo', 'fratello', 'lui', 'lui', 'il suo', 'figlio'], ['femmina', 'donna', 'ragazza', 'sorella', 'lei', 'sua', 'la sua', 'figlia']]
target_sets_names3 = ['Male Terms', 'Female Terms']
attribute_sets3 = [['matematica', 'algebra', 'geometria', 'calcolo', 'equazioni', 'calcolo', 'numeri', 'aggiunta'], ['poesia', 'arte', 'Shakespeare', 'danza', 'letteratura', 'romanzo', 'sinfonia', 'Dramma']]
