...
target_setsfr = [
    ["Masculin", "homme", "garçon", "frère", "il", "lui", "le sien", "fils"],
    ["femelle", "femme", "fille", "sœur", "elle", "sa", "la sienne", "la fille"],
]
...
# create the query
gender_query_fr1 = Query(
    target_setsfr, attribute_setsfr, target_sets_namesfr, attribute_sets_namesfr
)
...
# create the query
gender_query_fr2 = Query(
    target_setsfr2, attribute_setsfr2, target_sets_namesfr2, attribute_sets_namesfr2
)
...
# create the query
gender_query_fr3 = Query(
    target_setsfr3, attribute_setsfr3, target_sets_namesfr3, attribute_sets_namesfr3
)
