...
target_sets1 = [['mannelijk', 'Mens', 'jongen', 'broer', 'hij', 'hem', 'zijn', 'zoon'], ['vrouwelijk', 'vrouw', 'meisje', 'zus', 'ze', 'haar', 'haar', 'dochter']]
target_sets_names1 = ['Male Terms', 'Female Terms']
attribute_sets1 = [['leidinggevend', 'beheer', 'professioneel', 'bedrijf', 'salaris', 'kantoor', 'bedrijf', 'carrière'], ['huis', 'ouders', 'kinderen', 'familie', 'nichten en neven', 'huwelijk', 'bruiloft', 'familieleden']]
...
# create the word sets
target_sets2 = [['mannelijk', 'Mens', 'jongen', 'broer', 'hij', 'hem', 'zijn', 'zoon'], ['vrouwelijk', 'vrouw', 'meisje', 'zus', 'ze', 'haar', 'haar', 'dochter']]
target_sets_names2 = ['Male Terms', 'Female Terms']
attribute_sets2 = [['wetenschap', 'technologie', 'natuurkunde', 'scheikunde', 'Einstein', 'NASA', 'experiment', 'astronomie'], ['poëzie', 'kunst', 'dans', 'literatuur', 'roman', 'symfonie', 'drama', 'beeldhouwwerk']]
...
# create the word sets
target_sets3 = [['mannelijk', 'Mens', 'jongen', 'broer', 'hij', 'hem', 'zijn', 'zoon'], ['vrouwelijk', 'vrouw', 'meisje', 'zus', 'ze', 'haar', 'haar', 'dochter']]
target_sets_names3 = ['Male Terms', 'Female Terms']
attribute_sets3 = [['wiskunde', 'algebra', 'geometrie', 'rekening', 'vergelijkingen', 'berekening', 'cijfers', 'toevoeging'], ['poëzie', 'kunst', 'Shakespeare', 'dans', 'literatuur', 'roman', 'symfonie', 'drama']]
